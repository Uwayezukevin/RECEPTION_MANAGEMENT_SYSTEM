// src/pages/VisitorServiceRequest.jsx
  ...
  const validateStep2 = () => {
    ...
    if (formData.nationality === 'rwandan') {
      if (!formData.phoneNumber?.trim()) {
        newErrors.phoneNumber = "Phone number is required for Rwandan citizens";
      }
    } else {
      ...
      <div className="max-w-2xl mx-auto">
        ...
        {step === 1 && (
          <div className="bg-white rounded-xl shadow-lg p-6">
            <h2 className="text-2xl font-bold text-center mb-6">Select Your Nationality</h2>
            ...
            {errors.nationality && (
              <p className="mt-4 text-center text-red-500 text-sm">{errors.nationality}</p>
            )}
          </div>
        )}
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 p-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${errors.fullName ? 'border-red-500' : 'border-gray-300'}`}
                  />
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 p-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${errors.email ? 'border-red-500' : 'border-gray-300'}`}
                  />
                </div>
              ...
              <div>
                <label className="block text-sm font-medium mb-1">
                  Phone Number {formData.nationality === "rwandan" && "*"}
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 p-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${errors.phoneNumber ? 'border-red-500' : 'border-gray-300'}`}
                  />
                </div>
              ...
              {formData.nationality === "foreigner" && (
                <div>
                  ...
                  <div className="relative">
                    <GiPassport className="absolute left-3 top-3 text-gray-400" />
                    <input
                      type="text"
                      name="passportNumber"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className={`w-full pl-10 p-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${errors.service ? 'border-red-500' : 'border-gray-300'}`}
                  >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full pl-10 p-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${errors.eventDate ? 'border-red-500' : 'border-gray-300'}`}
                  />
                </div>
